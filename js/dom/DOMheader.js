...
import { createMainPage } from '../utils/createMainPage.js';
...
export const createHeader = () => { 
            ...
            <div class="section-header-bottom-wrapper">
                <nav>
                    <ul class="section-header-bottom-nav">
                        <li><a href="" class="mainPage">HOME</a></li>
                        <li><a href="#">SALE</a></li>
    ...
    document.querySelector('.mainPage').addEventListener('click', createMainPage);
}